...
// Sum256 returns the unkeyed BLAKE3 hash of b, truncated to 256 bits(32 bytes).
...
// Sum512 returns the unkeyed BLAKE3 hash of b, truncated to 512 bits(64 bytes).
...
// SumCustom returns the unkeyed BLAKE3 hash of b, truncated to custom bits(custom bits/8 bytes).
